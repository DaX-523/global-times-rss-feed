...
import finance3 from "../assets/global-markets-rally-on-economic-data-stock-market.jpg";
import { baseUrl, finance, technology } from "../lib/constants";
import formatRelativeDate from "../utils/formatRelativeDate";
import parseContent from "../lib/parseContent";

const getRandomImage = () => {
  const images = [finance3, finance1, finance2];
...
const Finance = () => {
  ...
  //     description: "Major Finance companies announce collaborative initiative to establish ethical guidelines for artificial intelligence development. The framework aims to ensure responsible AI deployment while fostering innovation.",
