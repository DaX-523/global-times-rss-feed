...
import stocks1 from "../assets/stocks.jpg";
import stocks2 from "../assets/stocks1.jpg";
import stocks3 from "../assets/electric-vehicle-market-expansion-major-automakers.jpg";
import stocks4 from "../assets/global-markets-rally-on-economic-data-stock-market.jpg";
import { stocks } from "../lib/constants";
import formatRelativeDate from "../utils/formatRelativeDate";
import useFeedData from "../hooks/useFeedData";

const getRandomImage = () => {
  const images = [stocks3, stocks1, stocks2, stocks4];
  const randomIndex = Math.floor(Math.random() * images.length);
  return images[randomIndex];
};

const Stocks = () => {
  const { data, loading, error } = useFeedData(stocks);
