...
import crypto1 from "../assets/cryptocurrency-regulation-framework-proposed.jpg";
import crypto2 from "../assets/cryptocurrencies1.jpg";
import crypto3 from "../assets/CryptocurrencySymbolsIllustration_remix_.png";
...
const Cryptocurrencies = () => {
  const { data, loading, error } = useFeedData(crypto);
        ...
        <div className="w-full border-b-4 border-black mb-4 sm:mb-6 md:mb-8">
          <div className="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-8">
            ...
            <div className="flex-1 text-center flex flex-col items-center">
              ...
              >
                {data?.feed?.title || "Cryptocurrency News"}
              </h1>
        ...
        {error && (
          <div className="max-w-[1920px] mx-auto px-4 py-12 text-center">
            <h2 className="text-2xl font-serif font-bold text-red-600 mb-4">
              Unable to load cryptocurrency news
            </h2>
